...
class MechanismParams:
    ...
    coinsurance: float = 0.0  # d in [0,1]: share of the indemnity withheld,
                              # claim paid = (1-d)*min(cov, L). The classical
                              # indemnity-side discipline instrument; swept in
                              # run_deductible_frontier.py (Prop. D benchmark)
